...
window = Tk()
window.iconbitmap('ezgif.com-gif-maker (12).ico')
...
photo1 = ImageTk.PhotoImage(file='resistornatalaga.png')
photo2 = ImageTk.PhotoImage(file='logopython.png')
photo3 = ImageTk.PhotoImage(file='nailawnaresistor.png')
...
x1 = PhotoImage(file="itim.png")
x10 = PhotoImage(file="kayumanggi.png")
x100 = PhotoImage(file="pula.png")
x1k = PhotoImage(file="orange.png")
x10k = PhotoImage(file="yellow.png")
x100k = PhotoImage(file="green.png")
x1M = PhotoImage(file="blue.png")
x10M = PhotoImage(file="violet.png")
x100M = PhotoImage(file="grey.png")
x1G = PhotoImage(file="white.png")
x100m = PhotoImage(file="gold.png")
x10m = PhotoImage(file="silver.png")
...
def five_band():
    tab1 = Toplevel()
    tab1.iconbitmap('ezgif.com-gif-maker (12).ico')
    tab1.config(bg='black')
    tab1.geometry("800x490")
    tab1.title("5-BAND RESISTOR COLOR CALCULATOR")

    # Resistor body and logos
    photoResistor = ImageTk.PhotoImage(file='resistornatalaga.png')
    photoPython = ImageTk.PhotoImage(file='logopython.png')
    photoDesign = ImageTk.PhotoImage(file='nailawnaresistor.png')
    ...
    x15 = PhotoImage(file="itim.png")
    x105 = PhotoImage(file="kayumanggi.png")
    x1005 = PhotoImage(file="pula.png")
    x1k5 = PhotoImage(file="orange.png")
    x10k5 = PhotoImage(file="yellow.png")
    x100k5 = PhotoImage(file="green.png")
    x1M5 = PhotoImage(file="blue.png")
    x10M5 = PhotoImage(file="violet.png")
    x100M5 = PhotoImage(file="grey.png")
    x1G5 = PhotoImage(file="white.png")
    x100m5 = PhotoImage(file="gold.png")
    x10m5 = PhotoImage(file="silver.png")
...
def six_band():
    tab2 = Toplevel()
    tab2.iconbitmap('ezgif.com-gif-maker (12).ico')
    ...
    x16 = PhotoImage(file="itim.png")
    x106 = PhotoImage(file="kayumanggi.png")
    x1006 = PhotoImage(file="pula.png")
    x1k6 = PhotoImage(file="orange.png")
    x10k6 = PhotoImage(file="yellow.png")
    x100k6 = PhotoImage(file="green.png")
    x1M6 = PhotoImage(file="blue.png")
    x10M6 = PhotoImage(file="violet.png")
    x100M6 = PhotoImage(file="grey.png")
    x1G6 = PhotoImage(file="white.png")
    x100m6 = PhotoImage(file="gold.png")
    x10m6 = PhotoImage(file="silver.png")
